...
&Scoped-define INTERNAL-TABLES esp-cfop-natur
...
&Scoped-define OPEN-QUERY-br-table OPEN QUERY {&SELF-NAME} FOR EACH esp-cfop-natur OF cfop-natur NO-LOCK     ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br-table esp-cfop-natur
&Scoped-define FIRST-TABLE-IN-QUERY-br-table esp-cfop-natur
...
<FOREIGN-KEYS>
cod-cfop||y|ems2esp.esp-cfop-natur.cod-cfop
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for BROWSE br-table
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH esp-cfop-natur OF cfop-natur NO-LOCK
    ~{&SORTBY-PHRASE}.
     _END_FREEFORM
...
DO:
    ...
    FIND esp-cfop-natur WHERE ROWID(esp-cfop-natur) = V-ROW no-error.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "cod-cfop" "esp-cfop-natur" "cod-cfop"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "esp-cfop-natur"}
