...
*******************************************************************************/
{include/i-prgvrs.i ESCRM010A 12.01.00.001}
...
def input param p-msg-crm like crm-web-processados.retorno-webservice no-undo.
...
&Scoped-Define ENABLED-OBJECTS RECT-1 edt-msg bt-ok bt-cancelar bt-ajuda 
...
DEFINE FRAME F-Main
     edt-msg AT ROW 1.13 COL 2 NO-LABEL WIDGET-ID 2
...
/* SETTINGS FOR FRAME F-Main
   FRAME-NAME                                                           */
ASSIGN 
       edt-msg:READ-ONLY IN FRAME F-Main        = TRUE.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-1 edt-msg bt-ok bt-cancelar bt-ajuda 
      WITH FRAME F-Main IN WINDOW w-window.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCRM010A" "12.01.00.001"}

  assign edt-msg = p-msg-crm.
