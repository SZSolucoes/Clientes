...
*******************************************************************************/
{include/i-prgvrs.i ESCRM004 2.04.00.001}
...
DEFINE VARIABLE i-minutos AS INTEGER FORMAT ">,>>9":U INITIAL 5 
     LABEL "Intervalo(Min)" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE text-modo-2 AS CHARACTER FORMAT "X(256)":U INITIAL "Repetiá∆o" 
      VIEW-AS TEXT 
     SIZE 10.86 BY .63 NO-UNDO.
...
DEFINE VARIABLE l-execucao-cont AS LOGICAL INITIAL no 
     LABEL "Execuá∆o Continua?" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME f-pg-log
     ...
     i-minutos AT ROW 10 COL 34 COLON-ALIGNED
     l-execucao-cont AT ROW 10.13 COL 4
     ...
     text-modo-2 AT ROW 9.25 COL 1 COLON-ALIGNED NO-LABEL
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Importaá∆o de Pedidos de Vendas"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
/* SETTINGS FOR FRAME f-pg-log
                                                                        */
/* SETTINGS FOR FILL-IN i-minutos IN FRAME f-pg-log
   NO-ENABLE                                                            */
/* SETTINGS FOR TOGGLE-BOX l-execucao-cont IN FRAME f-pg-log
   NO-ENABLE                                                            */
...
/* SETTINGS FOR FILL-IN text-modo-2 IN FRAME f-pg-log
   NO-DISPLAY NO-ENABLE                                                 */
ASSIGN 
       text-modo-2:PRIVATE-DATA IN FRAME f-pg-log     = 
                "Repetiá∆o".
...
ON END-ERROR OF C-Win /* Importaá∆o de Pedidos de Vendas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Importaá∆o de Pedidos de Vendas */
DO:
...
DO:
   ...
   IF SELF:SCREEN-VALUE = "2" THEN
       ENABLE l-execucao-cont
              i-minutos WITH FRAME f-pg-log.
   ELSE
       DISABLE 
              l-execucao-cont
              i-minutos WITH FRAME f-pg-log.
...
{utp/ut9000.i "ESCRM004" "2.04.00.001"}
...
------------------------------------------------------------------------------*/
  ENABLE bt-executar bt-cancelar bt-ajuda im-pg-lay im-pg-log 
  ...
  DISPLAY rs-todos rs-destino c-arquivo-destino rs-execucao i-minutos 
          l-execucao-cont 
      WITH FRAME f-pg-log IN WINDOW C-Win.
  ENABLE rs-todos rs-destino bt-config-impr-destino bt-arquivo-destino 
         c-arquivo-destino rs-execucao RECT-11 RECT-12 RECT-7 RECT-9 
      WITH FRAME f-pg-log IN WINDOW C-Win.
...
do  on error undo, return error
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.l-execucao-cont = input frame f-pg-log l-execucao-cont
           tt-param.i-minutos       = input frame f-pg-log i-minutos.
    ...
    {include/i-imrun.i esp/escrm004rp.p}
