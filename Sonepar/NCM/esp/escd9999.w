...
------------------------------------------------------------------------------*/
    ...
    for each tt-item where
        ...
        if not avail item then do:
            ...
            if item.class-fiscal <> tt-item.class-fiscal then
                put stream s-log unformatted
                    item.it-codigo ';'
                    'Classificaá∆o atual ':U + item.class-fiscal + ' diferente ' + tt-item.class-fiscal skip.
            else do:
                ...
                if not avail classif-fisc then
                    put stream s-log unformatted
                        item.it-codigo ';'
                        'Classificaá∆o Fiscal ':U + tt-item.new-class-fiscal + ' n∆o cadastrada':U skip.
                else do:
    ...
    message 'Importaá∆o Conclu°da':U
