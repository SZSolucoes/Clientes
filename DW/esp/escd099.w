...
*******************************************************************************/
{include/i-prgvrs.i ESCD099 1.00.00.001}
...
DEFINE FRAME f-relat
     ...
     im-pg-imp AT ROW 1.5 COL 18.14 WIDGET-ID 2
...
DEFINE FRAME f-pg-imp
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.92
         SIZE 77.43 BY 10.58 WIDGET-ID 100.
...
DEFINE FRAME f-pg-par
     ...
     text-entrada AT ROW 8.75 COL 4.14 NO-LABEL WIDGET-ID 8
     RECT-12 AT ROW 9 COL 2 WIDGET-ID 6
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.71
         SIZE 77 BY 11 WIDGET-ID 100.
...
{utp/ut9000.i "ESCD099" "1.00.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-12 cInputFile btInputFile 
      WITH FRAME f-pg-par IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.arq-entrada     = input frame f-pg-par cInputFile
           .
    ...
    {include/i-rprun.i esp/escd099rp.p}
