...
*******************************************************************************/
{include/i-prgvrs.i ESCM102-G01 2.12.00.001}
...
&Scoped-Define ENABLED-OBJECTS rt-button i_cod-acao bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS i_cod-acao 
...
DEFINE VARIABLE i_cod-acao AS INTEGER FORMAT ">>9":U 
     LABEL "A‡Æo" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     i_cod-acao AT ROW 1.96 COL 30 COLON-ALIGNED WIDGET-ID 2
...
FIND es-acordo-acao NO-LOCK
    WHERE es-acordo-acao.cod-acao EQ INPUT FRAME {&FRAME-NAME} i_cod-acao NO-ERROR.

IF NOT AVAILABLE es-acordo-acao THEN DO:
    {utp/ut-table.i ems2custom es-acordo-acao 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(es-acordo-acao).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY i_cod-acao 
      WITH FRAME d-vapara.
  ENABLE rt-button i_cod-acao bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCM102-G01" "2.12.00.001"}
