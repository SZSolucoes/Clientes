...
*******************************************************************************/
{include/i-prgvrs.i ESCM106A-Q01 2.12.00.001}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-acordo-area-ficha NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-acordo-area-ficha NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-acordo-area-ficha
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-acordo-area-ficha
...
num-ficha||y|ems2custom.es-acordo-area-ficha.num-ficha
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "cod-area,num-ficha"':U).
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ems2custom.es-acordo-area-ficha"
     _Options          = "NO-LOCK"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "num-ficha" "es-acordo-area-ficha" "num-ficha"}
