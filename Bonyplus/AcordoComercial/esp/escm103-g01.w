...
*******************************************************************************/
{include/i-prgvrs.i ESCM103-G01 2.12.00.001}
...
&Scoped-Define ENABLED-OBJECTS rt-button i_cod-linha bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS i_cod-linha 
...
DEFINE VARIABLE i_cod-linha AS INTEGER FORMAT ">9":U 
     LABEL "Linha Produto" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     i_cod-linha AT ROW 1.96 COL 30 COLON-ALIGNED WIDGET-ID 2
...
FIND es-acordo-linha NO-LOCK
    WHERE es-acordo-linha.cod-linha EQ INPUT FRAME {&FRAME-NAME} i_cod-linha NO-ERROR.

IF NOT AVAILABLE es-acordo-linha THEN DO:
    {utp/ut-table.i ems2custom es-acordo-linha 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(es-acordo-linha).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY i_cod-linha 
      WITH FRAME d-vapara.
  ENABLE rt-button i_cod-linha bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCM103-G01" "2.12.00.001"}
