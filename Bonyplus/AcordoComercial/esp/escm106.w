...
DEFINE FRAME f-cad
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 90 BY 18.67 WIDGET-ID 100.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_escm106-v01 ( 2.58 , 1.57 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Fichas' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 4.46 , 1.00 ) NO-ERROR.
       RUN set-size IN h_folder ( 15.04 , 90.00 ) NO-ERROR.
       ...
       RUN set-position IN h_escm106-b01 ( 5.79 , 2.57 ) NO-ERROR.
       ...
       RUN set-position IN h_escm106-q01 ( 1.13 , 65.72 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_escm106-q01 ).
