...
*******************************************************************************/
{include/i-prgvrs.i ESCM101-V01 2.12.00.001}
...
&Scoped-Define ENABLED-FIELDS es-acordo-area.descricao 
...
&Scoped-define ADM-CREATE-FIELDS es-acordo-area.cod-area 
...
DEFINE FRAME f-main
     es-acordo-area.cod-area AT ROW 1.33 COL 20.14 COLON-ALIGNED WIDGET-ID 2
          LABEL "µrea Comercial"
          VIEW-AS FILL-IN 
          SIZE 8 BY .88
     es-acordo-area.descricao AT ROW 3.04 COL 20 COLON-ALIGNED WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 40 BY .88
...
/*     {include/i-valid.i} */
    ...
    IF adm-new-record THEN DO:
        ...
        FIND es-acordo-area NO-LOCK
            WHERE es-acordo-area.cod-area = es-acordo-area.cod-area:input-value in frame {&FRAME-NAME} NO-ERROR.
        ...
        IF AVAIL es-acordo-area THEN DO:
            ...
            RUN utp/ut-msgs.p ("show",
                               1,
                               "µrea Comercial").
            APPLY 'entry' TO es-acordo-area.cod-area IN FRAME {&FRAME-NAME} .
            RETURN 'adm-error'.
        END.
        
    END.

    IF es-acordo-area.descricao:INPUT-VALUE IN FRAME {&FRAME-NAME} = "" THEN DO:

        RUN utp/ut-msgs.p ("show",
                            17006,
                           "Descri‡Æo ~~ Descri‡Æo deve ser diferente de branco").
        APPLY 'entry' TO es-acordo-area.descricao IN FRAME {&FRAME-NAME} .
        RETURN 'adm-error'.
