...
*******************************************************************************/
{include/i-prgvrs.i ESCM101-Q01 2.12.00.001}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-acordo-area NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-acordo-area NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-acordo-area
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-acordo-area
