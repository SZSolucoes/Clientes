...
*******************************************************************************/
{include/i-prgvrs.i ESCM111 2.12.00.001}
...
DEFINE VARIABLE rs-sit-acordo AS INTEGER INITIAL 4 
...
DEFINE VARIABLE c-nr-acordo-comerc-fim AS CHARACTER FORMAT "X(12)" INITIAL "ZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.

DEFINE VARIABLE c-nr-acordo-comerc-ini AS CHARACTER FORMAT "X(12)" 
     LABEL "Acordo Comercial" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.

DEFINE VARIABLE d-dt-criacao-fim AS DATE FORMAT "99/99/9999" INITIAL 12/31/25 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.

DEFINE VARIABLE d-dt-criacao-ini AS DATE FORMAT "99/99/9999" INITIAL 01/01/00 
     LABEL "Dt. Implantaá∆o" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.

DEFINE VARIABLE i-cod-area-fim AS INTEGER FORMAT ">>>>>9" INITIAL 999999 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 NO-UNDO.

DEFINE VARIABLE i-cod-area-ini AS INTEGER FORMAT ">>>>>9" INITIAL 0 
     LABEL "Area" 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 NO-UNDO.
...
DEFINE VARIABLE i-cod-repres-fim AS INTEGER FORMAT ">>>>9" INITIAL 99999 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 NO-UNDO.

DEFINE VARIABLE i-cod-repres-ini AS INTEGER FORMAT ">>>>9" INITIAL 0 
     LABEL "Repres" 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     c-estab-ini AT ROW 1.83 COL 25.72 COLON-ALIGNED HELP
          "C¢digo do estabelecimento."
     c-estab-fim AT ROW 1.83 COL 41.72 COLON-ALIGNED HELP
          "C¢digo do estabelecimento." NO-LABEL WIDGET-ID 2
     i-cod-area-ini AT ROW 2.83 COL 25.72 COLON-ALIGNED WIDGET-ID 6
     i-cod-area-fim AT ROW 2.83 COL 41.72 COLON-ALIGNED HELP
          "C¢digo do estabelecimento." NO-LABEL WIDGET-ID 4
     i-cod-repres-ini AT ROW 3.83 COL 25.72 COLON-ALIGNED WIDGET-ID 14
     i-cod-repres-fim AT ROW 3.83 COL 41.72 COLON-ALIGNED HELP
          "C¢digo do estabelecimento." NO-LABEL WIDGET-ID 12
     i-cod-emitente-ini AT ROW 4.83 COL 20.72 COLON-ALIGNED WIDGET-ID 22
     i-cod-emitente-fim AT ROW 4.83 COL 41.43 COLON-ALIGNED NO-LABEL WIDGET-ID 28
     c-nr-acordo-comerc-ini AT ROW 5.83 COL 20.72 COLON-ALIGNED WIDGET-ID 30
     c-nr-acordo-comerc-fim AT ROW 5.83 COL 41.57 COLON-ALIGNED NO-LABEL WIDGET-ID 36
     d-dt-criacao-ini AT ROW 6.83 COL 20.72 COLON-ALIGNED WIDGET-ID 38
     d-dt-criacao-fim AT ROW 6.83 COL 41.57 COLON-ALIGNED NO-LABEL WIDGET-ID 44
     IMAGE-1 AT ROW 1.83 COL 33
     IMAGE-2 AT ROW 1.83 COL 40.29
     IMAGE-3 AT ROW 2.83 COL 33 WIDGET-ID 8
     IMAGE-4 AT ROW 2.83 COL 40.29 WIDGET-ID 10
     IMAGE-5 AT ROW 3.83 COL 33 WIDGET-ID 16
     IMAGE-6 AT ROW 3.83 COL 40.29 WIDGET-ID 18
     IMAGE-7 AT ROW 4.83 COL 33 WIDGET-ID 24
     IMAGE-8 AT ROW 4.83 COL 40.29 WIDGET-ID 26
     IMAGE-9 AT ROW 5.83 COL 33 WIDGET-ID 32
     IMAGE-10 AT ROW 5.83 COL 40.29 WIDGET-ID 34
     IMAGE-11 AT ROW 6.83 COL 33 WIDGET-ID 42
     IMAGE-12 AT ROW 6.83 COL 40.29 WIDGET-ID 40
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
DEFINE FRAME f-pg-par
     rs-sit-acordo AT ROW 2.29 COL 5 NO-LABEL WIDGET-ID 6
     "Situaá∆o Acordo Comercial" VIEW-AS TEXT
          SIZE 27 BY .67 AT ROW 1.29 COL 5.57 WIDGET-ID 4
     RECT-10 AT ROW 1.67 COL 3.29 WIDGET-ID 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
...
{utp/ut9000.i "ESCM111" "2.12.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-estab-ini c-estab-fim i-cod-area-ini i-cod-area-fim i-cod-repres-ini 
          i-cod-repres-fim i-cod-emitente-ini i-cod-emitente-fim 
          c-nr-acordo-comerc-ini c-nr-acordo-comerc-fim d-dt-criacao-ini 
          d-dt-criacao-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 
         IMAGE-9 IMAGE-10 IMAGE-11 IMAGE-12 c-estab-ini c-estab-fim 
         i-cod-area-ini i-cod-area-fim i-cod-repres-ini i-cod-repres-fim 
         i-cod-emitente-ini i-cod-emitente-fim c-nr-acordo-comerc-ini 
         c-nr-acordo-comerc-fim d-dt-criacao-ini d-dt-criacao-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ...
  DISPLAY rs-sit-acordo 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE RECT-10 rs-sit-acordo 
      WITH FRAME f-pg-par IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.cod-area-ini         = INPUT FRAME f-pg-sel i-cod-area-ini
           tt-param.cod-area-fim         = INPUT FRAME f-pg-sel i-cod-area-fim
           tt-param.cod-repres-ini       = INPUT FRAME f-pg-sel i-cod-repres-ini
           tt-param.cod-repres-fim       = INPUT FRAME f-pg-sel i-cod-repres-fim
           ...
           tt-param.nr-acordo-comerc-ini = INPUT FRAME f-pg-sel c-nr-acordo-comerc-ini
           tt-param.nr-acordo-comerc-fim = INPUT FRAME f-pg-sel c-nr-acordo-comerc-fim
           tt-param.dt-criacao-ini       = INPUT FRAME f-pg-sel d-dt-criacao-ini
           tt-param.dt-criacao-fim       = INPUT FRAME f-pg-sel d-dt-criacao-fim
           tt-param.sit-acordo        = INPUT FRAME f-pg-par rs-sit-acordo
           .
    ...
    {include/i-rprun.i esp/escm111rp.p}
