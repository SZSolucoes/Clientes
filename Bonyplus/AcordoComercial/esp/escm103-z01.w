...
*******************************************************************************/
{include/i-prgvrs.i ESCM103-Z01 2.12.00.001}
...
DEFINE VARIABLE h_escm103-b01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     bt-ok AT ROW 15.42 COL 3
     bt-cancela AT ROW 15.42 COL 14
     bt-ajuda AT ROW 15.42 COL 79
     rt-button AT ROW 15.17 COL 2
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Linha Produto' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/escm103-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_escm103-b01 ).
       RUN set-position IN h_escm103-b01 ( 3.00 , 6.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.14 ) */

       /* Links to SmartBrowser h_escm103-b01. */
       RUN add-link IN adm-broker-hdl ( h_escm103-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_escm103-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCM103-Z01" "2.12.00.001"}
