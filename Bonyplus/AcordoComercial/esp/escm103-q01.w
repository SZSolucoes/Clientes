...
*******************************************************************************/
{include/i-prgvrs.i ESCM103-Q01 2.12.00.001}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-acordo-linha NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-acordo-linha NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-acordo-linha
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-acordo-linha
...
<FOREIGN-KEYS>
cod-linha||y|ems2custom.es-acordo-linha.cod-linha
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ems2custom.es-acordo-linha"
     _Options          = "NO-LOCK"
