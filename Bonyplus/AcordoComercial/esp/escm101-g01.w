...
*******************************************************************************/
{include/i-prgvrs.i ESCM101-G01 2.12.00.001}
...
&Scoped-Define ENABLED-OBJECTS rt-button i_cod-area bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS i_cod-area 
...
DEFINE FRAME d-vapara
     i_cod-area AT ROW 2 COL 28 COLON-ALIGNED WIDGET-ID 2
...
FIND es-acordo-area NO-LOCK
    WHERE es-acordo-area.cod-area EQ INPUT FRAME {&FRAME-NAME} i_cod-area NO-ERROR.

IF NOT AVAILABLE es-acordo-area THEN DO:
    {utp/ut-table.i ems2custom es-acordo-area 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(es-acordo-area).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY i_cod-area 
      WITH FRAME d-vapara.
  ENABLE rt-button i_cod-area bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
