...
*******************************************************************************/
{include/i-prgvrs.i ESCM102-Q01 2.12.00.001}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-acordo-acao NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-acordo-acao NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-acordo-acao
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-acordo-acao
...
<FOREIGN-KEYS>
cod-acao||y|ems2custom.es-acordo-acao.cod-acao
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
