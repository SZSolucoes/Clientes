...
*******************************************************************************/
{include/i-prgvrs.i ESCM106A 2.12.00.000}
...
DEFINE VARIABLE h_escm106a-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_escm106a-v01 AS HANDLE NO-UNDO.
...
DO:
{include/okfil.i h_escm106a-v01}
END.
...
DO:
{include/salvafil.i h_escm106a-v01}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_escm106a-q01 ).
       RUN set-position IN h_escm106a-q01 ( 1.00 , 68.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_escm106a-v01. */
       RUN add-link IN adm-broker-hdl ( h_escm106a-q01 , 'Record':U , h_escm106a-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_escm106a-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_escm106a-v01 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "escm106a" "2.12.00.000"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

  run pi-atualiza-parent in h_escm106a-v01 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_escm106a-q01 (input v-row-table).
