...
&Scoped-Define ENABLED-FIELDS ext-emitente.log-gera-edi ~
ext-emitente.dir-copia-xml 
...
&Scoped-Define DISPLAYED-FIELDS ext-emitente.log-gera-edi ~
ext-emitente.dir-copia-xml 
...
DEFINE FRAME f-main
     ext-emitente.log-gera-edi AT ROW 2.38 COL 22.43 WIDGET-ID 4
          VIEW-AS TOGGLE-BOX
          SIZE 16.43 BY .83
     ext-emitente.dir-copia-xml AT ROW 3.63 COL 20.14 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 41.86 BY .88
     rt-mold AT ROW 1 COL 1
     RECT-10 AT ROW 2 COL 2.72 WIDGET-ID 12
...
------------------------------------------------------------------------------*/
  ...
  if not avail ext-emitente then do with frame {&frame-name} :
      assign ext-emitente.log-gera-edi:checked = no
             ext-emitente.dir-copia-xml:screen-value = "".
  end.
