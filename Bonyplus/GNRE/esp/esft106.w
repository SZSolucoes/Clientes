...
*******************************************************************************/
{include/i-prgvrs.i ESFT106 2.12.00.001}
...
DEFINE VARIABLE c-cod-lote-fim AS CHARACTER FORMAT "X(12)":U INITIAL "ZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-cod-lote-ini AS CHARACTER FORMAT "X(12)":U 
     LABEL "Lote GNRE" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-cod-usuario-fim AS CHARACTER FORMAT "X(12)":U INITIAL "ZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.

DEFINE VARIABLE c-cod-usuario-ini AS CHARACTER FORMAT "X(12)":U 
     LABEL "Usuario" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.
...
DEFINE VARIABLE c-uf-fim AS CHARACTER FORMAT "X(5)":U INITIAL "ZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 NO-UNDO.

DEFINE VARIABLE c-uf-ini AS CHARACTER FORMAT "X(5)":U 
     LABEL "UF" 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 NO-UNDO.

DEFINE VARIABLE d-dt-lote-fim AS DATE FORMAT "99/99/9999":U 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE d-dt-lote-ini AS DATE FORMAT "99/99/9999":U 
     LABEL "Data Lote" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE i-cod-receita-fim AS INTEGER FORMAT "999999":U INITIAL 999999 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.

DEFINE VARIABLE i-cod-receita-ini AS INTEGER FORMAT "999999":U INITIAL 0 
     LABEL "Receita" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     c-cod-estabel-ini AT ROW 1.88 COL 15 COLON-ALIGNED
     c-cod-estabel-fim AT ROW 1.88 COL 48.72 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     c-serie-ini AT ROW 2.88 COL 15 COLON-ALIGNED WIDGET-ID 6
     c-serie-fim AT ROW 2.88 COL 48.72 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     c-nr-nota-fis-ini AT ROW 3.88 COL 15 COLON-ALIGNED WIDGET-ID 14
     c-nr-nota-fis-fim AT ROW 3.88 COL 48.86 COLON-ALIGNED NO-LABEL WIDGET-ID 20
     c-uf-ini AT ROW 4.88 COL 15 COLON-ALIGNED WIDGET-ID 42
     c-uf-fim AT ROW 4.88 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 48
     c-cod-lote-ini AT ROW 5.83 COL 15 COLON-ALIGNED WIDGET-ID 24
     c-cod-lote-fim AT ROW 5.83 COL 48.86 COLON-ALIGNED NO-LABEL WIDGET-ID 22
     d-dt-lote-ini AT ROW 6.88 COL 15 COLON-ALIGNED WIDGET-ID 60
     d-dt-lote-fim AT ROW 6.88 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 66
     i-cod-receita-ini AT ROW 7.88 COL 15 COLON-ALIGNED WIDGET-ID 32
     i-cod-receita-fim AT ROW 7.88 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 38
     c-cod-usuario-ini AT ROW 8.88 COL 15 COLON-ALIGNED WIDGET-ID 70
     c-cod-usuario-fim AT ROW 8.88 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 76
     IMAGE-1 AT ROW 1.88 COL 32.43
     IMAGE-2 AT ROW 1.88 COL 47.29
     IMAGE-3 AT ROW 2.88 COL 32.43 WIDGET-ID 8
     IMAGE-4 AT ROW 2.88 COL 47.29 WIDGET-ID 10
     IMAGE-5 AT ROW 3.88 COL 32.43 WIDGET-ID 16
     IMAGE-6 AT ROW 3.88 COL 47.29 WIDGET-ID 18
     IMAGE-7 AT ROW 5.83 COL 32.43 WIDGET-ID 26
     IMAGE-8 AT ROW 5.83 COL 47.29 WIDGET-ID 28
     IMAGE-9 AT ROW 7.88 COL 32.43 WIDGET-ID 34
     IMAGE-10 AT ROW 7.88 COL 47.29 WIDGET-ID 36
     IMAGE-11 AT ROW 4.88 COL 32.43 WIDGET-ID 44
     IMAGE-12 AT ROW 4.88 COL 47.29 WIDGET-ID 46
     IMAGE-15 AT ROW 6.88 COL 32.43 WIDGET-ID 62
     IMAGE-16 AT ROW 6.88 COL 47.29 WIDGET-ID 64
     IMAGE-17 AT ROW 8.88 COL 32.43 WIDGET-ID 74
     IMAGE-18 AT ROW 8.88 COL 47.29 WIDGET-ID 72
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
{utp/ut9000.i "ESFT106" "2.12.00.001"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN d-dt-lote-ini:SCREEN-VALUE IN FRAME f-pg-sel = STRING(TODAY - 30)
           d-dt-lote-fim:SCREEN-VALUE IN FRAME f-pg-sel = STRING(TODAY).
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-cod-estabel-ini c-cod-estabel-fim c-serie-ini c-serie-fim 
          c-nr-nota-fis-ini c-nr-nota-fis-fim c-uf-ini c-uf-fim c-cod-lote-ini 
          c-cod-lote-fim d-dt-lote-ini d-dt-lote-fim i-cod-receita-ini 
          i-cod-receita-fim c-cod-usuario-ini c-cod-usuario-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 
         IMAGE-9 IMAGE-10 IMAGE-11 IMAGE-12 IMAGE-15 IMAGE-16 IMAGE-17 IMAGE-18 
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.cod-lote-ini         = INPUT FRAME f-pg-sel c-cod-lote-ini
           tt-param.cod-lote-fim         = INPUT FRAME f-pg-sel c-cod-lote-fim
           tt-param.dt-lote-ini          = INPUT FRAME f-pg-sel d-dt-lote-ini
           tt-param.dt-lote-fim          = INPUT FRAME f-pg-sel d-dt-lote-fim
           tt-param.cod-receita-ini      = INPUT FRAME f-pg-sel i-cod-receita-ini
           tt-param.cod-receita-fim      = INPUT FRAME f-pg-sel i-cod-receita-fim
           tt-param.cod-usuario-ini      = INPUT FRAME f-pg-sel c-cod-usuario-ini
           tt-param.cod-usuario-fim      = INPUT FRAME f-pg-sel c-cod-usuario-fim
           .
    ...
    {include/i-rprun.i esp/esft106rp.p}
