...
*******************************************************************************/
{include/i-prgvrs.i ESNF001-G01 2.06.00.001}
...
&Scoped-Define ENABLED-OBJECTS rt-button c_cod-estabel i_cod-emitente bt-ok ~
bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_cod-estabel i_cod-emitente 
...
DEFINE FRAME d-vapara
     c_cod-estabel AT ROW 1.46 COL 30 COLON-ALIGNED WIDGET-ID 2
     i_cod-emitente AT ROW 2.46 COL 30 COLON-ALIGNED WIDGET-ID 4
...
DO:
FIND nfe008 NO-LOCK
    WHERE nfe008.cod-estabel EQ INPUT FRAME {&FRAME-NAME} c_cod-estabel
      AND nfe008.cod-emitente EQ INPUT FRAME {&FRAME-NAME} i_cod-emitente NO-ERROR.

IF NOT AVAILABLE nfe008 THEN DO:
    {utp/ut-table.i ems2custom nfe008 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(nfe008).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY c_cod-estabel i_cod-emitente 
      WITH FRAME d-vapara.
  ENABLE rt-button c_cod-estabel i_cod-emitente bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESNF001-G01" "2.06.00.001"}
