...
*******************************************************************************/
{include/i-prgvrs.i G01ESNF012 2.06.00.001}
...
&Scoped-Define ENABLED-OBJECTS rt-button c_ch-acesso-comp-nfe bt-ok ~
bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_ch-acesso-comp-nfe 
...
DEFINE VARIABLE c_ch-acesso-comp-nfe AS CHARACTER FORMAT "x(60)":U 
     LABEL "Chave Acesso" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     c_ch-acesso-comp-nfe AT ROW 2.04 COL 16 COLON-ALIGNED WIDGET-ID 2
...
DO:
FIND nfe003 NO-LOCK
    WHERE nfe003.ch-acesso-comp-nfe EQ INPUT FRAME {&FRAME-NAME} c_ch-acesso-comp-nfe NO-ERROR.

IF NOT AVAILABLE nfe003 THEN DO:
    {utp/ut-table.i movnfe nfe003 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(nfe003).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY c_ch-acesso-comp-nfe 
      WITH FRAME d-vapara.
  ENABLE rt-button c_ch-acesso-comp-nfe bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "G01ESNF012" "2.06.00.001"}
