...
*******************************************************************************/
{include/i-prgvrs.i ESNF012-Z01 2.06.00.001}
...
DEFINE VARIABLE ESh_esnf012-b03 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_folder ( 13.67 , 93.43 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/esnf012-b03.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT ESh_esnf012-b03 ).
       RUN set-position IN ESh_esnf012-b03 ( 3.00 , 6.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.14 ) */

       /* Links to SmartBrowser ESh_esnf012-b03. */
       RUN add-link IN adm-broker-hdl ( ESh_esnf012-b03 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( ESh_esnf012-b03 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESNF012-Z01" "2.06.00.001"}
