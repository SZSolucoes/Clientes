...
*******************************************************************************/
{include/i-prgvrs.i ESNF001-Z01 2.06.00.001}
...
DEFINE VARIABLE h_esnf001-b01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/esnf001-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esnf001-b01 ).
       RUN set-position IN h_esnf001-b01 ( 2.92 , 5.72 ) NO-ERROR.
       /* Size in UIB:  ( 11.17 , 80.14 ) */

       /* Links to SmartBrowser h_esnf001-b01. */
       RUN add-link IN adm-broker-hdl ( h_esnf001-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esnf001-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESFT001-Z01" "2.06.00.001"}
