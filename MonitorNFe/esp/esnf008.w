...
*******************************************************************************/
{include/i-prgvrs.i ESNF008 2.00.00.000}
...
DEFINE VARIABLE h_esnf008-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esnf008-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     ...
     bt-cancela AT ROW 7.71 COL 14
     bt-imprime AT ROW 7.71 COL 25
     bt-ajuda AT ROW 7.71 COL 75.72
     rt-button AT ROW 7.5 COL 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 86.14 BY 12.54 WIDGET-ID 100.
...
ON END-ERROR OF w-cadsim /* Parƒmetros XML NFE */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Parƒmetros XML NFE */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_folder ( 6.00 , 85.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esvwr/esnf008-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esnf008-v01 ).
       RUN set-position IN h_esnf008-v01 ( 2.63 , 2.43 ) NO-ERROR.
       /* Size in UIB:  ( 4.00 , 84.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esqry/esnf008-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_esnf008-q01 ).
       RUN set-position IN h_esnf008-q01 ( 7.25 , 50.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Links to SmartViewer h_esnf008-v01. */
       RUN add-link IN adm-broker-hdl ( h_esnf008-q01 , 'Record':U , h_esnf008-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_esnf008-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             bt-ok:HANDLE IN FRAME f-cad , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esnf008-v01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESNF008" "2.00.00.000"}
