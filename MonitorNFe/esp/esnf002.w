...
*******************************************************************************/
{include/i-prgvrs.i ESNF002 2.00.00.000}
...
DEFINE VARIABLE d-data     AS DATE FORMAT 99/99/9999       NO-UNDO.
...
DEFINE VARIABLE text-entrada AS CHARACTER FORMAT "X(256)":U INITIAL "Diret¢rio Arquivos" 
      VIEW-AS TEXT 
...
DEFINE FRAME f-relat
     ...
     im-pg-imp AT ROW 1.5 COL 17.89
     im-pg-par AT ROW 1.5 COL 2.11
...
DEFINE FRAME f-pg-par
     bt-arquivo-entrada AT ROW 5.7 COL 64.89 HELP
          "Escolha do nome do arquivo" WIDGET-ID 2
     c-arquivo-entrada AT ROW 5.77 COL 9.33 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL WIDGET-ID 4 NO-TAB-STOP 
     text-entrada AT ROW 4.77 COL 10 NO-LABEL WIDGET-ID 8
     RECT-8 AT ROW 4.87 COL 8 WIDGET-ID 6
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 75 BY 10.33 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Integra‡Æo XML de Notas Fiscais"
         HEIGHT             = 15
         WIDTH              = 81.11
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.33
...
ON END-ERROR OF w-relat /* Integra‡Æo XML de Notas Fiscais */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Integra‡Æo XML de Notas Fiscais */
DO:
...
DO:
    ...
    run utp/ut-dir.p (input "Selecione o diret¢rio", output c-arq-aux, output l-cancelado).

    if l-cancelado = no then do:
         assign c-arquivo-entrada = c-arq-aux.
         disp c-arquivo-entrada with frame {&frame-name}.
    end.
...
{utp/ut9000.i "ESNF002" "2.00.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    IF AVAIL nfe019 THEN
        ASSIGN c-arquivo-entrada:SCREEN-VALUE IN FRAME f-pg-par = nfe019.diretorio-xml.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-8 bt-arquivo-entrada 
      WITH FRAME f-pg-par IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esp/esnf002rp.p}    
