...
*******************************************************************************/
{include/i-prgvrs.i esnf016 2.06.00.001}
...
DEFINE VARIABLE h_esnf016-b01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esnf016-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esnf016-v01 AS HANDLE NO-UNDO.
...
ON END-ERROR OF w-cadpaifilho-filho /* Manuten‡Æo CFOP */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadpaifilho-filho w-cadpaifilho-filho
ON WINDOW-CLOSE OF w-cadpaifilho-filho /* Manuten‡Æo CFOP */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esvwr/esnf016-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esnf016-v01 ).
       RUN set-position IN h_esnf016-v01 ( 2.54 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.25 , 90.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adm/objects/folder.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'Natur Oper' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 4.33 , 1.00 ) NO-ERROR.
       RUN set-size IN h_folder ( 13.42 , 90.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/esnf016-b01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = ?,
                     ProgAtributo = ,
                     ProgIncMod = esp\esnf016a.w,
                     MessageNum = 0,
                     MessageParam = ':U ,
             OUTPUT h_esnf016-b01 ).
       RUN set-position IN h_esnf016-b01 ( 5.58 , 2.14 ) NO-ERROR.
       /* Size in UIB:  ( 12.04 , 86.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esqry/esnf016-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = eszoom\esnf016-z01.w,
                     ProgVaPara = esgo\esnf016-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_esnf016-q01 ).
       RUN set-position IN h_esnf016-q01 ( 1.08 , 65.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.25 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , THIS-PROCEDURE ).

       /* Links to SmartViewer h_esnf016-v01. */
       RUN add-link IN adm-broker-hdl ( h_esnf016-q01 , 'Record':U , h_esnf016-v01 ).

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Links to BrowserCadastro2 h_esnf016-b01. */
       RUN add-link IN adm-broker-hdl ( h_esnf016-q01 , 'Record':U , h_esnf016-b01 ).

       /* Links to SmartQuery h_esnf016-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_esnf016-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_esnf016-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_esnf016-q01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navega ,
             h_p-exihel , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esnf016-v01 ,
             h_p-navega , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             h_esnf016-v01 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esnf016-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esnf016.w" "2.06.00.001"}
