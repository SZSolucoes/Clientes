...
*******************************************************************************/
{include/i-prgvrs.i ESNF014 2.06.00.001}
...
DEFINE VARIABLE rd-sefaz AS INTEGER INITIAL 1 
     VIEW-AS RADIO-SET VERTICAL
     RADIO-BUTTONS 
          "Notas n∆o autorizadas pelo SEFAZ", 1,
"Notas autorizadas pelo SEFAZ", 2,
"Todas as notas fiscais", 3
...
DEFINE VARIABLE c-emit-fim AS INTEGER FORMAT ">>>>>>>>9":U INITIAL 999999999 
     VIEW-AS FILL-IN 
     SIZE 12 BY .87 NO-UNDO.

DEFINE VARIABLE c-emit-ini AS INTEGER FORMAT ">>>>>>>>9":U INITIAL 0 
     LABEL "Emitente" 
     VIEW-AS FILL-IN 
     SIZE 12 BY .87 NO-UNDO.
...
DEFINE FRAME f-pg-imp
     rs-destino AT ROW 1.63 COL 3.33 HELP
          "Destino de Impress∆o do Relat¢rio" NO-LABEL
     bt-config-impr AT ROW 2.7 COL 43.33 HELP
          "Configuraá∆o da impressora"
     bt-arquivo AT ROW 2.7 COL 43.33 HELP
          "Escolha do nome do arquivo"
     c-arquivo AT ROW 2.77 COL 3.33 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     l-habilitaRtf AT ROW 4.83 COL 3.33
     c-modelo-rtf AT ROW 6.63 COL 3 HELP
          "Nome do arquivo de modelo do relat¢rio" NO-LABEL
     bt-modelo-rtf AT ROW 6.63 COL 43 HELP
          "Escolha do nome do arquivo"
     rs-execucao AT ROW 8.87 COL 2.89 HELP
          "Modo de Execuá∆o" NO-LABEL
     text-destino AT ROW 1.03 COL 3.89 NO-LABEL
     text-rtf AT ROW 4.17 COL 1.11 COLON-ALIGNED NO-LABEL
     text-modelo-rtf AT ROW 5.97 COL 1.11 COLON-ALIGNED NO-LABEL
     text-modo AT ROW 8.13 COL 1.11 COLON-ALIGNED NO-LABEL
     rect-rtf AT ROW 4.47 COL 2
     RECT-7 AT ROW 1.33 COL 2.11
...
DEFINE FRAME f-relat
     ...
     RECT-6 AT ROW 13.77 COL 2.11
     rt-folder-top AT ROW 2.53 COL 2.11
     rt-folder-right AT ROW 2.67 COL 80.45
     rt-folder-left AT ROW 2.53 COL 2.11
     rt-folder AT ROW 2.5 COL 2
     im-pg-imp AT ROW 1.5 COL 33.56
     im-pg-par AT ROW 1.5 COL 17.89
     im-pg-sel AT ROW 1.5 COL 2.11
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 81 BY 15
...
DEFINE FRAME f-pg-sel
     c-emit-ini AT ROW 1.7 COL 20.22 COLON-ALIGNED WIDGET-ID 12
     c-emit-fim AT ROW 1.7 COL 40 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     d-data-ini AT ROW 2.7 COL 20 COLON-ALIGNED WIDGET-ID 4
     d-data-fim AT ROW 2.7 COL 40 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     IMAGE-1 AT ROW 1.8 COL 35.22 WIDGET-ID 14
     IMAGE-2 AT ROW 1.8 COL 38.67 WIDGET-ID 16
     IMAGE-3 AT ROW 2.9 COL 34.89 WIDGET-ID 8
     IMAGE-4 AT ROW 2.87 COL 38.67 WIDGET-ID 10
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
DEFINE FRAME f-pg-par
     rd-sefaz AT ROW 2.93 COL 7 NO-LABEL WIDGET-ID 2
     "Autorizaá∆o de Notas Fiscais" VIEW-AS TEXT
          SIZE 26 BY .67 AT ROW 1.53 COL 6 WIDGET-ID 8
     RECT-10 AT ROW 1.8 COL 4 WIDGET-ID 6
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
...
{utp/ut9000.i "ESNF014" "2.06.00.001"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    IF  NOT THIS-PROCEDURE:PERSISTENT THEN
     ...
     ASSIGN d-data-ini:SCREEN-VALUE IN FRAME f-pg-sel = STRING(TODAY - 1) 
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-emit-ini c-emit-fim d-data-ini d-data-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 c-emit-ini c-emit-fim d-data-ini 
         d-data-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
DO ON ERROR UNDO, RETURN ERROR ON STOP UNDO, RETURN ERROR:
    ...
    ASSIGN tt-param.usuario         = c-seg-usuario
           ...
           &endif
           tt-param.emit-ini = INPUT FRAME f-pg-sel c-emit-ini
           tt-param.emit-fim = INPUT FRAME f-pg-sel c-emit-fim
           tt-param.data-ini = INPUT FRAME f-pg-sel d-data-ini
           tt-param.data-fim = INPUT FRAME f-pg-sel d-data-fim
           tt-param.rd-sefaz = INPUT FRAME f-pg-par rd-sefaz.
    ...
    {include/i-rprun.i esp/esnf014rp.p}
