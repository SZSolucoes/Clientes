...
*******************************************************************************/
{include/i-prgvrs.i ESNF009A 2.06.00.001}
...
DEFINE VARIABLE h_esnf009a-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esnf009a-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 8.17 COL 2.43 HELP
          "Salva e sai"
     bt-save AT ROW 8.17 COL 12.86 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 8.17 COL 23.43 HELP
          "Cancela"
     bt-ajuda AT ROW 8.17 COL 70.57
     rt-button AT ROW 8 COL 1.43
...
DO:
{include/okfil.i h_esnf009a-v01}
END.
...
DO:
{include/salvafil.i h_esnf009a-v01}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Incluir' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.54 , 2.00 ) NO-ERROR.
       RUN set-size IN h_folder ( 6.21 , 79.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esvwr/esnf009a-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esnf009a-v01 ).
       RUN set-position IN h_esnf009a-v01 ( 3.00 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.25 , 77.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esqry/esnf009a-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_esnf009a-q01 ).
       RUN set-position IN h_esnf009a-q01 ( 1.00 , 47.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Links to SmartViewer h_esnf009a-v01. */
       RUN add-link IN adm-broker-hdl ( h_esnf009a-q01 , 'Record':U , h_esnf009a-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_esnf009a-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             bt-ok:HANDLE IN FRAME f-cad , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esnf009a-v01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESNF009A" "2.06.00.001"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

  run pi-atualiza-parent in h_esnf009a-v01 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_esnf009a-q01 (input v-row-table).
