...
*******************************************************************************/
{include/i-prgvrs.i ESNF010 2.06.00.001}
...
DEFINE VARIABLE h_esnf010-b01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 90 BY 14.38 WIDGET-ID 100.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_esnf009-v01 ( 2.71 , 1.57 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Item/Fornec' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 5.21 , 1.00 ) NO-ERROR.
       RUN set-size IN h_folder ( 9.83 , 90.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/esnf010-b01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esnf010-b01 ).
       RUN set-position IN h_esnf010-b01 ( 7.00 , 5.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Key-Name = ,
                     ...
                     Implantar = no':U ,
             OUTPUT h_q01ad098 ).
       RUN set-position IN h_q01ad098 ( 1.00 , 51.00 ) NO-ERROR.
       ...
       /* Links to SmartBrowser h_esnf010-b01. */
       RUN add-link IN adm-broker-hdl ( h_q01ad098 , 'Record':U , h_esnf010-b01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_esnf010-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESNF010" "2.06.00.001"}
