...
&Scoped-define FIELDS-IN-QUERY-brMsg tt-nfe017.texto-msg tt-nfe017.cd-msg ~
tt-nfe017.log-ativo tt-nfe017.hr-msg tt-nfe017.dt-msg 
...
&Scoped-Define ENABLED-OBJECTS btSimula btAtualiza rtToolBar-2 btQueryJoins ~
...
DEFINE BUTTON btAtualiza 
     ...
     LABEL "" 
     SIZE 5 BY 1.27 TOOLTIP "Atualiza Documentos".
...
DEFINE BUTTON btParam 
     ...
     LABEL "Parametros" 
     SIZE 5 BY 1.27 TOOLTIP "ParÉmetros Documentos".
...
DEFINE BUTTON btSelecao 
     ...
     LABEL "Seleá∆o" 
     SIZE 5 BY 1.27 TOOLTIP "Seleá∆o Documentos".
...
DEFINE BUTTON btSimula 
     ...
     LABEL "Simula" 
     SIZE 5 BY 1.27 TOOLTIP "Simular Integraá∆o com Recebimento Fiscal".
...
DEFINE BUTTON btAgregado 
     ...
     LABEL "Nota Agregada" 
     SIZE 5.56 BY 1.5 TOOLTIP "Nota Agregada"
     FONT 4.
...
DEFINE BUTTON btChave 
     ...
     LABEL "Chave Doc" 
     SIZE 5.56 BY 1.5 TOOLTIP "Chave Documento".
...
DEFINE BUTTON btElimina 
     ...
     LABEL "Elimina" 
     SIZE 5.56 BY 1.5 TOOLTIP "Elimina Registro de NFe Selecionado".
...
DEFINE BUTTON btModifica 
     ...
     LABEL "Modifica" 
     SIZE 5.56 BY 1.5 TOOLTIP "Modifica Documento".
...
DEFINE BUTTON btReativa 
     ...
     LABEL "Reativar" 
     SIZE 5.56 BY 1.5 TOOLTIP "Reativar Documento no Monitor".

DEFINE BUTTON btReprocessa 
     IMAGE-UP FILE "image/toolbar/im-chck1.bmp":U
     IMAGE-INSENSITIVE FILE "image/toolbar/ii-chck1.bmp":U NO-FOCUS FLAT-BUTTON
     LABEL "Proc Fiscal" 
     SIZE 5.56 BY 1.5 TOOLTIP "Processar Documento Recebimento Fiscal".
...
DEFINE BUTTON btReprocessaFis 
     ...
     LABEL "Proc F°sico" 
     SIZE 5.56 BY 1.5 TOOLTIP "Processar Documento Recebimento F°sico".
...
DEFINE BUTTON btValida 
     ...
     LABEL "ValidaNfe" 
     SIZE 5.56 BY 1.5 TOOLTIP "Valida NFe Sefaz".
...
DEFINE BUTTON btVaPara 
     ...
     LABEL "V† Para" 
     SIZE 5.56 BY 1.5 TOOLTIP "V† Para Chave de Acesso".
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brMsg wWindow _STRUCTURED
  QUERY brMsg NO-LOCK DISPLAY
      ...
      tt-nfe017.cd-msg FORMAT ">>>>9":U
      tt-nfe017.log-ativo FORMAT "Sim/N∆o":U
      tt-nfe017.hr-msg FORMAT "x(08)":U WIDTH 7.56
      tt-nfe017.dt-msg FORMAT "99/99/9999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 131 BY 3.7
         FONT 1.
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 95 BY 17.2
...
DEFINE FRAME fpage0
     ...
     btQueryJoins AT ROW 1.13 COL 120.11 HELP
          "Consultas relacionadas"
     btReportsJoins AT ROW 1.13 COL 124.11 HELP
          "Relat¢rios relacionados"
     btExit AT ROW 1.13 COL 128.11 HELP
          "Sair"
     btHelp AT ROW 1.13 COL 132.11 HELP
          "Ajuda"
     btParam AT ROW 1.13 COL 1.56 WIDGET-ID 2
     btSelecao AT ROW 1.13 COL 6.67 WIDGET-ID 4
...
DEFINE FRAME fPage1
     btAgregado AT ROW 15.87 COL 99 HELP
          "Notas Fiscais Referenciadas" WIDGET-ID 6
     btValida AT ROW 14.3 COL 99 WIDGET-ID 32
     btChave AT ROW 9.67 COL 99 WIDGET-ID 10
     btDocumento AT ROW 11.2 COL 99 WIDGET-ID 24
     brTable1 AT ROW 1.8 COL 3 WIDGET-ID 200
     btElimina AT ROW 12.77 COL 99 WIDGET-ID 30
     brMsg AT ROW 20 COL 3 WIDGET-ID 300
     btModifica AT ROW 5.03 COL 99 WIDGET-ID 4
     btReativa AT ROW 3.5 COL 99 WIDGET-ID 36
     btReprocessa AT ROW 6.57 COL 99 WIDGET-ID 8
     btReprocessaFis AT ROW 8.13 COL 99 WIDGET-ID 34
     btVaPara AT ROW 1.97 COL 99 WIDGET-ID 2
     c-nfe AT ROW 1.13 COL 2 COLON-ALIGNED NO-LABEL WIDGET-ID 18
     c-msg-nfe AT ROW 19.27 COL 2 COLON-ALIGNED NO-LABEL WIDGET-ID 20
     RECT-10 AT ROW 1.43 COL 2 WIDGET-ID 12
     RECT-11 AT ROW 19.5 COL 2 WIDGET-ID 14
     RECT-13 AT ROW 1.8 COL 98.33 WIDGET-ID 42
     IMAGE-21 AT ROW 1.8 COL 108.11 WIDGET-ID 52
     RECT-14 AT ROW 1.43 COL 106.67 WIDGET-ID 54
...
/* SETTINGS FOR FRAME fPage1
                                                                        */
/* BROWSE-TAB brTable1 btDocumento fPage1 */
/* BROWSE-TAB brMsg btElimina fPage1 */
...
DO:
    ...
    IF  AVAIL tt-nfe003
    AND tt-nfe003.log-multi-cfop THEN
        ASSIGN tt-nfe003.cod-estabel:BGCOLOR  IN BROWSE brTable1 = 1
               tt-nfe003.cod-estabel:FGCOLOR  IN BROWSE brTable1 = 15
               tt-nfe003.cod-emitente:BGCOLOR IN BROWSE brTable1 = 1
               tt-nfe003.cod-emitente:FGCOLOR IN BROWSE brTable1 = 15
               tt-nfe003.serie-docto:BGCOLOR  IN BROWSE brTable1 = 1
               tt-nfe003.serie-docto:FGCOLOR  IN BROWSE brTable1 = 15
               tt-nfe003.nro-docto:BGCOLOR    IN BROWSE brTable1 = 1
               tt-nfe003.nro-docto:FGCOLOR    IN BROWSE brTable1 = 15
               tt-nfe003.dt-emissao:BGCOLOR   IN BROWSE brTable1 = 1
               tt-nfe003.dt-emissao:FGCOLOR   IN BROWSE brTable1 = 15
               c-situacao:BGCOLOR             IN BROWSE brTable1 = 1
               c-situacao:FGCOLOR             IN BROWSE brTable1 = 15 
               c-desc-sit-sefaz:BGCOLOR       IN BROWSE brTable1 = 1 
               c-desc-sit-sefaz:FGCOLOR       IN BROWSE brTable1 = 15.
    ELSE
        ASSIGN tt-nfe003.cod-estabel:BGCOLOR  IN BROWSE brTable1 = ?
               tt-nfe003.cod-estabel:FGCOLOR  IN BROWSE brTable1 = ?
               tt-nfe003.cod-emitente:BGCOLOR IN BROWSE brTable1 = ?
               tt-nfe003.cod-emitente:FGCOLOR IN BROWSE brTable1 = ?
               tt-nfe003.serie-docto:BGCOLOR  IN BROWSE brTable1 = ?
               tt-nfe003.serie-docto:FGCOLOR  IN BROWSE brTable1 = ?
               tt-nfe003.nro-docto:BGCOLOR    IN BROWSE brTable1 = ?
               tt-nfe003.nro-docto:FGCOLOR    IN BROWSE brTable1 = ?
               tt-nfe003.dt-emissao:BGCOLOR   IN BROWSE brTable1 = ?
               tt-nfe003.dt-emissao:FGCOLOR   IN BROWSE brTable1 = ?
               c-situacao:BGCOLOR                   IN BROWSE brTable1 = ?
               c-situacao:FGCOLOR                   IN BROWSE brTable1 = ?
               c-desc-sit-sefaz:BGCOLOR       IN BROWSE brTable1 = ? 
...
DO:
    ...
    RUN pi-inicializar IN h-acomp (INPUT "Simulando integraá∆o").
