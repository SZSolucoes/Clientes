...
*******************************************************************************/
{include/i-prgvrs.i ESNF011 2.06.00.001}
...
DEFINE FRAME f-relat
     ...
     im-pg-cla AT ROW 1.5 COL 17.89
...
DEFINE FRAME f-pg-imp
     rs-destino AT ROW 2.37 COL 3.33 HELP
          "Destino de Impress∆o do Relat¢rio" NO-LABEL
     bt-arquivo AT ROW 3.57 COL 43.33 HELP
          "Escolha do nome do arquivo"
     bt-config-impr AT ROW 3.57 COL 43.33 HELP
          "Configuraá∆o da impressora"
     c-arquivo AT ROW 3.63 COL 3.33 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     rs-execucao AT ROW 5.77 COL 3 HELP
          "Modo de Execuá∆o" NO-LABEL
     text-destino AT ROW 1.63 COL 3.89 NO-LABEL
     text-modo AT ROW 5 COL 1.33 COLON-ALIGNED NO-LABEL
     RECT-7 AT ROW 1.93 COL 2.11
     RECT-9 AT ROW 5.3 COL 2.11
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
...
DEFINE FRAME f-pg-cla
     rs-classif AT ROW 1.8 COL 2.56 HELP
          "Classificaá∆o para emiss∆o do relat¢rio" NO-LABEL
     "Classificaá∆o" VIEW-AS TEXT
          SIZE 14 BY .67 AT ROW 1.07 COL 4 WIDGET-ID 4
     RECT-11 AT ROW 1.37 COL 1.45 WIDGET-ID 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
...
DEFINE FRAME f-pg-sel
     i-emit-ini AT ROW 2.17 COL 25.56 COLON-ALIGNED
     i-emit-fim AT ROW 2.17 COL 46 COLON-ALIGNED NO-LABEL
     IMAGE-1 AT ROW 2.27 COL 41.78
     IMAGE-2 AT ROW 2.27 COL 45.11
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
{utp/ut9000.i "ESNF011" "2.06.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY i-emit-ini i-emit-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 i-emit-ini i-emit-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
/*     end.                                                                                         */
    ...
    {include/i-rprun.i esp/esnf011rp.p}
