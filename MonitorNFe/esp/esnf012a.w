...
DEFINE VARIABLE h_esnf012a-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esnf012a-v01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esnf012a-v02 AS HANDLE NO-UNDO.
...
ON END-ERROR OF w-concom /* Consulta <Insira complemento> */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-concom w-concom
ON WINDOW-CLOSE OF w-concom /* Consulta <Insira complemento> */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esvwr/esnf012a-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esnf012a-v01 ).
       RUN set-position IN h_esnf012a-v01 ( 2.92 , 1.72 ) NO-ERROR.
       /* Size in UIB:  ( 1.50 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adm/objects/folder.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'Detalhar 1' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 4.71 , 1.57 ) NO-ERROR.
       RUN set-size IN h_folder ( 12.54 , 88.57 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esqry/esnf012a-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_esnf012a-q01 ).
       RUN set-position IN h_esnf012a-q01 ( 1.25 , 51.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_esnf012a-v01. */
       RUN add-link IN adm-broker-hdl ( h_esnf012a-q01 , 'Record':U , h_esnf012a-v01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-navega , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esnf012a-v01 ,
             h_p-exihel , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             h_esnf012a-v01 , 'AFTER':U ).
    END. /* Page 0 */
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esvwr/esnf012a-v02.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esnf012a-v02 ).
       RUN set-position IN h_esnf012a-v02 ( 6.29 , 3.29 ) NO-ERROR.
       /* Size in UIB:  ( 10.25 , 86.00 ) */

       /* Links to SmartViewer h_esnf012a-v02. */
       RUN add-link IN adm-broker-hdl ( h_esnf012a-q01 , 'Record':U , h_esnf012a-v02 ).
       RUN add-link IN adm-broker-hdl ( h_esnf012a-v01 , 'Group-Assign':U , h_esnf012a-v02 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             h_esnf012a-v01 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esnf012a-v02 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
