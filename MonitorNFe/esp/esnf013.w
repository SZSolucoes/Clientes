...
*******************************************************************************/
{include/i-prgvrs.i ESNF013 2.06.00.001}
...
DEFINE VARIABLE tg-atualiz-receb AS LOGICAL INITIAL yes 
     LABEL "Atualizada no Recebimento" 
     VIEW-AS TOGGLE-BOX
     SIZE 30 BY 1 TOOLTIP "Nota Atualizada no Recebimento" NO-UNDO.

DEFINE VARIABLE tg-danfe-nao-autor AS LOGICAL INITIAL yes 
     LABEL "DANFE n∆o Autorizado" 
     VIEW-AS TOGGLE-BOX
     SIZE 25 BY 1 TOOLTIP "DANFE n∆o Autorizado" NO-UNDO.

DEFINE VARIABLE tg-digit-receb AS LOGICAL INITIAL yes 
     LABEL "Digitada no Recebimento" 
     VIEW-AS TOGGLE-BOX
     SIZE 28.72 BY 1 TOOLTIP "Nota Digitada no Recebimento" NO-UNDO.

DEFINE VARIABLE tg-doc-liber AS LOGICAL INITIAL yes 
     LABEL "Documentos Liberados" 
     VIEW-AS TOGGLE-BOX
     SIZE 33 BY 1 TOOLTIP "Documentos Liberados" NO-UNDO.

DEFINE VARIABLE tg-elimin-receb AS LOGICAL INITIAL yes 
     LABEL "Eliminada no Recebimento" 
     VIEW-AS TOGGLE-BOX
     SIZE 28.72 BY 1 TOOLTIP "Nota Eliminada no Recebimento" NO-UNDO.

DEFINE VARIABLE tg-nota-erro-neg AS LOGICAL INITIAL yes 
     LABEL "Nota com Erro Neg¢cio" 
     VIEW-AS TOGGLE-BOX
     SIZE 25 BY 1 TOOLTIP "Nota com Erro de Negocio" NO-UNDO.

DEFINE VARIABLE c-doc-fim AS CHARACTER FORMAT "X(16)":U INITIAL "ZZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 13.57 BY .88 TOOLTIP "Numero Documento Final" NO-UNDO.

DEFINE VARIABLE c-doc-ini AS CHARACTER FORMAT "X(16)":U INITIAL "0" 
     LABEL "Documento" 
     VIEW-AS FILL-IN 
     SIZE 13.57 BY .88 TOOLTIP "N£mero do Documento Inicial" NO-UNDO.

DEFINE VARIABLE c-serie-fim AS CHARACTER FORMAT "X(5)":U INITIAL "ZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 5.57 BY .88 TOOLTIP "SÇrie Fim" NO-UNDO.

DEFINE VARIABLE c-serie-ini AS CHARACTER FORMAT "X(5)":U INITIAL "0" 
     LABEL "SÇrie" 
     VIEW-AS FILL-IN 
     SIZE 5.57 BY .88 TOOLTIP "SÇrie inicial" NO-UNDO.

DEFINE VARIABLE d-data-emis-fim AS DATE FORMAT "99/99/9999":U INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 10.57 BY .88 TOOLTIP "Data Emissao Fim" NO-UNDO.

DEFINE VARIABLE d-data-emis-ini AS DATE FORMAT "99/99/9999":U INITIAL 01/01/1900 
     LABEL "Data Emiss∆o" 
     VIEW-AS FILL-IN 
     SIZE 10.57 BY .88 TOOLTIP "Data Emiss∆o Inicial" NO-UNDO.

DEFINE VARIABLE i-emit-fim AS INTEGER FORMAT ">>>>>>>>9":U INITIAL 999999999 
     VIEW-AS FILL-IN 
     SIZE 8.57 BY .88 TOOLTIP "Emitente Fim" NO-UNDO.

DEFINE VARIABLE i-emit-ini AS INTEGER FORMAT ">>>>>>>>9":U INITIAL 0 
     LABEL "Emitente" 
     VIEW-AS FILL-IN 
     SIZE 8.57 BY .88 TOOLTIP "Emitente Inicial" NO-UNDO.
...
DEFINE FRAME f-pg-par
     tg-digit-receb AT ROW 2.5 COL 8.86
     tg-nota-erro-neg AT ROW 3.5 COL 8.86 WIDGET-ID 2
     tg-atualiz-receb AT ROW 4.54 COL 8.86 WIDGET-ID 6
     tg-elimin-receb AT ROW 5.46 COL 8.86 WIDGET-ID 8
     tg-danfe-nao-autor AT ROW 6.46 COL 8.86 WIDGET-ID 10
     tg-doc-liber AT ROW 7.46 COL 8.86 WIDGET-ID 12
     "Situaá∆o Documento" VIEW-AS TEXT
          SIZE 20 BY 1 AT ROW 1.25 COL 9 WIDGET-ID 22
     RECT-14 AT ROW 1.75 COL 5 WIDGET-ID 18
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
...
DEFINE FRAME f-pg-sel
     c-doc-ini AT ROW 1.88 COL 21.86 COLON-ALIGNED
     c-doc-fim AT ROW 1.88 COL 44.43 COLON-ALIGNED NO-LABEL
     c-serie-ini AT ROW 2.83 COL 29.86 COLON-ALIGNED WIDGET-ID 2
     c-serie-fim AT ROW 2.83 COL 44.43 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     i-emit-ini AT ROW 3.79 COL 26.86 COLON-ALIGNED WIDGET-ID 6
     i-emit-fim AT ROW 3.79 COL 44.43 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     d-data-emis-ini AT ROW 4.75 COL 24.86 COLON-ALIGNED WIDGET-ID 10
     d-data-emis-fim AT ROW 4.75 COL 44.43 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     IMAGE-1 AT ROW 1.88 COL 37.57
     IMAGE-2 AT ROW 1.88 COL 43.29
     IMAGE-3 AT ROW 2.83 COL 37.57 WIDGET-ID 14
     IMAGE-4 AT ROW 2.83 COL 43.29 WIDGET-ID 16
     IMAGE-5 AT ROW 3.79 COL 37.57 WIDGET-ID 18
     IMAGE-6 AT ROW 3.79 COL 43.29 WIDGET-ID 20
     IMAGE-7 AT ROW 4.75 COL 37.57 WIDGET-ID 22
     IMAGE-8 AT ROW 4.75 COL 43.29 WIDGET-ID 24
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
{utp/ut9000.i "ESNF013" "2.06.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-doc-ini c-doc-fim c-serie-ini c-serie-fim i-emit-ini i-emit-fim 
          d-data-emis-ini d-data-emis-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 
         c-doc-ini c-doc-fim c-serie-ini c-serie-fim i-emit-ini i-emit-fim 
         d-data-emis-ini d-data-emis-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ...
  DISPLAY tg-digit-receb tg-nota-erro-neg tg-atualiz-receb tg-elimin-receb 
          tg-danfe-nao-autor tg-doc-liber 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE RECT-14 tg-digit-receb tg-nota-erro-neg tg-atualiz-receb 
         tg-elimin-receb tg-danfe-nao-autor tg-doc-liber 
      WITH FRAME f-pg-par IN WINDOW w-relat.
...
/*                                             rs-classif:radio-buttons in frame f-pg-cla) */
           ...
           &endif
           tt-param.doc-ini         = INPUT FRAME f-pg-sel c-doc-ini
           tt-param.doc-fim         = INPUT FRAME f-pg-sel c-doc-fim
           ...
           tt-param.data-emis-ini   = INPUT FRAME f-pg-sel d-data-emis-ini
           tt-param.data-emis-fim   = INPUT FRAME f-pg-sel d-data-emis-fim
           tt-param.digit-receb     = INPUT FRAME f-pg-par tg-digit-receb
           tt-param.nota-erro-neg   = INPUT FRAME f-pg-par tg-nota-erro-neg
           tt-param.atualiz-receb   = INPUT FRAME f-pg-par tg-atualiz-receb
           tt-param.elimin-receb    = INPUT FRAME f-pg-par tg-elimin-receb
           tt-param.danfe-nao-autor = INPUT FRAME f-pg-par tg-danfe-nao-autor
           tt-param.doc-liber       = INPUT FRAME f-pg-par tg-doc-liber.
    ...
    {include/i-rprun.i esp/esnf013rp.p}
