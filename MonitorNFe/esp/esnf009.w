...
*******************************************************************************/
{include/i-prgvrs.i ESNF009 2.06.00.001}
...
DEFINE VARIABLE h_esnf009-b01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esnf009-v01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esvwr/esnf009-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esnf009-v01 ).
       RUN set-position IN h_esnf009-v01 ( 2.79 , 1.72 ) NO-ERROR.
       /* Size in UIB:  ( 2.25 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adm/objects/folder.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'Item Fornec' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 5.25 , 1.00 ) NO-ERROR.
       RUN set-size IN h_folder ( 10.00 , 90.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/esnf009-b01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = ?,
                     ProgAtributo = ,
                     ProgIncMod = esp\esnf009a.w,
                     MessageNum = 0,
                     MessageParam = ':U ,
             OUTPUT h_esnf009-b01 ).
       RUN set-position IN h_esnf009-b01 ( 6.75 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 7.92 , 77.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Key-Name = ,
                     ...
                     Implantar = no':U ,
             OUTPUT h_q01ad098 ).
       RUN set-position IN h_q01ad098 ( 1.00 , 57.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , THIS-PROCEDURE ).

       /* Links to SmartViewer h_esnf009-v01. */
       RUN add-link IN adm-broker-hdl ( h_q01ad098 , 'Record':U , h_esnf009-v01 ).

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).
       RUN add-link IN adm-broker-hdl ( h_folder , 'State':U , THIS-PROCEDURE ).

       /* Links to BrowserCadastro2 h_esnf009-b01. */
       RUN add-link IN adm-broker-hdl ( h_q01ad098 , 'Record':U , h_esnf009-b01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navega ,
             h_p-exihel , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esnf009-v01 ,
             h_p-navega , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             h_esnf009-v01 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esnf009-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESNF009" "2.00.00.001"}
