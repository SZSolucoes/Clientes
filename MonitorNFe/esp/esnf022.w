...
*******************************************************************************/
{include/i-prgvrs.i ESNF022 2.12.00.001}
...
DEFINE VARIABLE d-dt-emissao-fim AS DATE FORMAT "99/99/9999":U INITIAL ? 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE d-dt-emissao-ini AS DATE FORMAT "99/99/9999":U INITIAL ? 
     LABEL "Data Emiss∆o" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     d-dt-emissao-ini AT ROW 1.67 COL 18.14 COLON-ALIGNED
     d-dt-emissao-fim AT ROW 1.67 COL 44.14 COLON-ALIGNED NO-LABEL
     IMAGE-1 AT ROW 1.67 COL 35
     IMAGE-2 AT ROW 1.67 COL 43.29
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
{utp/ut9000.i "ESNF022" "2.12.00.001"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    {include/i-rpmbl.i}
        ...
        ASSIGN d-dt-emissao-ini:SCREEN-VALUE IN FRAME f-pg-sel = STRING(TODAY - 7)
               d-dt-emissao-fim:SCREEN-VALUE IN FRAME f-pg-sel = STRING(TODAY).
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY d-dt-emissao-ini d-dt-emissao-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 d-dt-emissao-ini d-dt-emissao-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esp/esnf022rp.p}
