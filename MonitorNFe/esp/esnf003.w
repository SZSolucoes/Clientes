...
&Scoped-Define ENABLED-OBJECTS btSimula rtToolBar-2 btQueryJoins ~
btReportsJoins btExit btHelp btAtualiza btParam btSelecao 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brMsg wWindow _STRUCTURED
  QUERY brMsg NO-LOCK DISPLAY
      ...
      tt-nfe017.hr-msg FORMAT "x(08)":U WIDTH 7.57
...
/* SETTINGS FOR FRAME fPage1
                                                                        */
/* BROWSE-TAB brTable1 RECT-14 fPage1 */
...
"tt-nfe017.hr-msg" ? ? "character" ? ? ? ? ? ? no ? no no "7.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO:
    IF brTable1:NUM-SELECTED-ROWS = 1 THEN DO:
        ...
        IF AVAIL tt-nfe003 then do:
            ...
            if substring(tt-nfe003.ch-acesso-comp-nfe,1,1) = "9" then
                next.
            ...
            for each tt_log_erro:
                ...
                FOR FIRST nfe003 EXCLUSIVE-LOCK
                    ...
                    IF  TT_LOG_ERRO.TTV_NUM_COD_ERRO = 53045 THEN DO:
                    ...
                    IF  TT_LOG_ERRO.TTV_DES_MSG_ERRO begins "(100) Autorizado o uso da NF-e" THEN
