...
*******************************************************************************/
{include/i-prgvrs.i esnf016a 2.06.00.001}
...
DEFINE VARIABLE h_esnf016a-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esnf016a-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 4.5 COL 2.57 HELP
          "Salva e sai"
     bt-save AT ROW 4.5 COL 13 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 4.5 COL 23.57 HELP
          "Cancela"
     bt-ajuda AT ROW 4.5 COL 75.57
     rt-button AT ROW 4.33 COL 1.57
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 89 BY 4.92 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsim ASSIGN
         HIDDEN             = YES
         TITLE              = "Inclui/Modifica Nat Oper"
         HEIGHT             = 4.83
         WIDTH              = 88.29
         MAX-HEIGHT         = 26.75
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-cadsim /* Inclui/Modifica Nat Oper */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Inclui/Modifica Nat Oper */
DO:
...
DO:
{include/okfil.i h_esnf016a-v01}
END.
...
DO:
{include/salvafil.i h_esnf016a-v01}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esvwr/esnf016a-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esnf016a-v01 ).
       RUN set-position IN h_esnf016a-v01 ( 1.00 , 1.14 ) NO-ERROR.
       /* Size in UIB:  ( 3.25 , 88.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esqry/esnf016a-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_esnf016a-q01 ).
       RUN set-position IN h_esnf016a-q01 ( 4.50 , 68.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.17 , 7.72 ) */

       /* Links to SmartViewer h_esnf016a-v01. */
       RUN add-link IN adm-broker-hdl ( h_esnf016a-q01 , 'Record':U , h_esnf016a-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_esnf016a-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esnf016a-v01 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esnf016a" "2.06.00.001"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .
  
  run pi-atualiza-parent in h_esnf016a-v01 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_esnf016a-q01 (input v-row-table).
