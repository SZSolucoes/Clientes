...
&Scoped-define FIELDS-IN-QUERY-br-table nfe003.ch-acesso-comp-nfe 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-table 
&Scoped-define QUERY-STRING-br-table FOR EACH nfe003 WHERE ~{&KEY-PHRASE} ~
      AND idi-orig-trad = 2               and ~
c-inicial <= ch-acesso-comp-nfe and ~
c-final   >= ch-acesso-comp-nfe NO-LOCK ~
...
<FOREIGN-KEYS>
ch-acesso-comp-nfe|y|y|movnfe.nfe003.ch-acesso-comp-nfe
...
RUN set-attribute-list (
    'Keys-Accepted = "ch-acesso-comp-nfe",
     Keys-Supplied = "ch-acesso-comp-nfe,cod-emitente"':U).
...
DEFINE VARIABLE c-final AS CHARACTER FORMAT "X(256)":U INITIAL "99999999999999999999999999999999999999999999999999" 
     VIEW-AS FILL-IN 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _STRUCTURED
  QUERY br-table NO-LOCK DISPLAY
      nfe003.ch-acesso-comp-nfe FORMAT "x(60)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br-table
     _TblList          = "movnfe.nfe003"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "idi-orig-trad = 2               and
c-inicial <= ch-acesso-comp-nfe and
c-final   >= ch-acesso-comp-nfe"
     _FldNameList[1]   = movnfe.nfe003.ch-acesso-comp-nfe
...
DEFINE INPUT PARAMETER P-CAMPO AS CHARACTER NO-UNDO.
    ...
    if  avail nfe003 then do:
        case p-campo:
            when "ch-acesso-comp-nf" then
                assign p-valor = string(nfe003.ch-acesso-comp-nf).
        end.
    end.
    return p-valor.
END PROCEDURE.
