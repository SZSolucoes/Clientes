...
&Scoped-define INTERNAL-TABLES nfe020 item

/* Definitions for BROWSE br-table                                      */
&Scoped-define FIELDS-IN-QUERY-br-table nfe020.it-codigo item.desc-item ~
nfe020.item-do-forn 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-table 
&Scoped-define QUERY-STRING-br-table FOR EACH nfe020 OF emitente NO-LOCK, ~
      EACH item OF nfe020 NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-br-table OPEN QUERY br-table FOR EACH nfe020 OF emitente NO-LOCK, ~
      EACH item OF nfe020 NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br-table nfe020 item
&Scoped-define FIRST-TABLE-IN-QUERY-br-table nfe020
...
<FOREIGN-KEYS>
cod-emitente||y|movnfe.nfe020.cod-emitente
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _STRUCTURED
  QUERY br-table NO-LOCK DISPLAY
      nfe020.it-codigo COLUMN-LABEL "Cod Item" FORMAT "x(16)":U
      item.desc-item FORMAT "x(60)":U WIDTH 35.86
      nfe020.item-do-forn FORMAT "x(16)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 77 BY 6.9.
...
DEFINE FRAME F-Main
     ...
     bt-incluir AT ROW 7.92 COL 1
     bt-modificar AT ROW 7.92 COL 11
     bt-eliminar AT ROW 7.92 COL 21
...
/* Query rebuild information for BROWSE br-table
     _TblList          = "movnfe.nfe020 OF mgadm.emitente,mgind.item OF movnfe.nfe020"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _FldNameList[1]   > movnfe.nfe020.it-codigo
"nfe020.it-codigo" "Cod Item" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > mgind.item.desc-item
"item.desc-item" ? ? "character" ? ? ? ? ? ? no ? no no "35.86" yes no no "U" "" ""
     _FldNameList[3]   = movnfe.nfe020.item-do-forn
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "cod-emitente" "nfe020" "cod-emitente"}
