...
*******************************************************************************/
{include/i-prgvrs.i esnf016-q01 2.06.00.001}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH cfop-natur ~
      WHERE cfop-natur.cod-cfop >= "5000" NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH cfop-natur ~
      WHERE cfop-natur.cod-cfop >= "5000" NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main cfop-natur
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main cfop-natur
