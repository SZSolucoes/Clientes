...
*******************************************************************************/
{include/i-prgvrs.i esnf016a-q01 2.06.00.001}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-natur-cfop NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-natur-cfop NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main es-natur-cfop
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-natur-cfop
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ems2custom.es-natur-cfop"
