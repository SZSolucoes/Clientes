...
&Scoped-define INTERNAL-TABLES param-re

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH param-re NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH param-re NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main param-re
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main param-re
...
<FOREIGN-KEYS>
usuario||y|mgind.param-re.usuario
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
