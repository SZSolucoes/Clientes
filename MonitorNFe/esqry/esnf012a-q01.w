...
&Scoped-define QUERY-STRING-Query-Main FOR EACH nfe013 ~
      WHERE rowid(nfe013) = r-rowid-linha ~
 NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH nfe013 ~
      WHERE rowid(nfe013) = r-rowid-linha ~
 NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main nfe013
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main nfe013
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "movnfe.nfe013"
     _Options          = "NO-LOCK"
     _Where[1]         = "rowid(nfe013) = r-rowid-linha
"
