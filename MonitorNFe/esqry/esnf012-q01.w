...
&Scoped-define QUERY-STRING-Query-Main FOR EACH nfe003 ~
      WHERE idi-orig-trad = 2 ~
 NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH nfe003 ~
      WHERE idi-orig-trad = 2 ~
 NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main nfe003
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main nfe003
