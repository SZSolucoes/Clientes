...
define new global shared variable wh-esnf012-ch-acesso as char format "x(254)" no-undo.
...
DEFINE FRAME f-main
     nfe003.ch-acesso-comp-nfe AT ROW 1.25 COL 16 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 61.14 BY .88
...
/* assign wh-esnf012-ch-acesso = int(nfe003.ch-acesso-comp-nfe:screen-value in frame {&frame-name}). */

assign r-rowid = rowid(nfe003).

/* ASSIGN nfe003.ch-acesso-comp-nfe:FORMAT IN FRAME {&frame-name} = "99.9999.99.999.999/9999-99-99-999-999.999.999-999.999.999-9".  */
